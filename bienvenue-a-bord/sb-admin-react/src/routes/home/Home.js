    ...
    <div>
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <Panel
            header={<span>
              <i className="fa fa-bar-chart-o fa-fw" /> Envie de voyager... 
              <div className="pull-right">
                <DropdownButton title="Voyages" bsSize="xs" pullRight id="dropdownButton1" >
                  <MenuItem eventKey="1">Effectués</MenuItem>
                  <MenuItem eventKey="2">Prévus</MenuItem>
                  <MenuItem eventKey="3">À faire</MenuItem>
                </DropdownButton>
              </div>
            </span>}
          >
